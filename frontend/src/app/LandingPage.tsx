            ...
            <section className="mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center gap-16 px-8 py-12 lg:flex-row">
                ...
                <div className="max-w-2xl text-center lg:text-left">
                    ...
                    <p className="mt-6 text-lg leading-8 text-slate-300">
                        Browse available vehicles, manage dealership inventory,
                        purchase cars, restock inventory, and securely administer
                        your dealership from one modern dashboard.
                    </p>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="rounded-xl bg-white/10 p-5">
                                ...
                                <p className="mt-2 text-sm text-slate-300">
                                    Create, update, delete and manage your
                                    dealership inventory effortlessly.
                                </p>
                            </div>
                            ...
                            <div className="rounded-xl bg-white/10 p-5">
                                ...
                                <p className="mt-2 text-sm text-slate-300">
                                    Search vehicles by make, model, category and
                                    price instantly.
                                </p>
                            </div>
                            ...
                            <div className="rounded-xl bg-white/10 p-5">
                                ...
                                <p className="mt-2 text-sm text-slate-300">
                                    JWT protected routes with administrator
                                    inventory controls.
                                </p>
                            </div>
                            ...
                            <div className="rounded-xl bg-white/10 p-5">
                                ...
                                <p className="mt-2 text-sm text-slate-300">
                                    Purchase vehicles, monitor stock levels and
